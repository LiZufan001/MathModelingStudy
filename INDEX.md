...
2025 A 题另收录**全国二等奖公开算法工程**，与国一 `M` 统计分开管理：[进入国二补充材料](papers/CPMCM/2025/SECOND_PRIZE_REFERENCES.md)。

## 阅读建议

1. 先看某年的 `problems/CPMCM/<year>/README.md`，确认题目与数据来源。
2. 再看同年的 `papers/CPMCM/<year>/VERIFIED_FIRST_PRIZE.md`，选择有官方证据的一等奖作品作为拆解对象。
3. 国二等奖例等补充材料单独管理，只作为学习和算法对照，不并入国一 `M` 覆盖统计。
4. 找全文时优先走研创网“优秀作品”官方入口，不使用无法证明奖项身份的网盘文件替代。
